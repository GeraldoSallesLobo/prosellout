...
- **Evoluções**: Análise Mensal agrupa semanas no padrão Excel (`WEEKNUM`, semana começando no domingo) e Histórico 3 Meses usa o mês final do período filtrado como M, exibindo M-2, M-1 e M com variações M x M-2/M-1.
