...
- **Cache por sessão**: o `AppProviders` escuta mudanças do Supabase Auth e, quando o usuário muda ou desloga, limpa o TanStack Query **e a indústria selecionada** — evitando dados de uma sessão anterior após novo login e garantindo que todo login passe pela seleção de indústria.
