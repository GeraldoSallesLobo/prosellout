...
const IMPORT_LAYOUT_SPECS: ImportLayoutSpec[] = [
  ...
  {
    code: "ROUTE_PLAN",
    title: "Roteiro de Visitas (Planner)",
    screen: "Planner › Parametrização",
    targetTable: "planner_route_visits",
    status: "ready",
    summary: "Roteiro de visitas por PDV × vendedor × semana usado pelos planificadores.",
    prerequisiteCodes: ["SELLERS", "CUSTOMERS"],
    requiredColumns: ["CNPJ Distribuidor", "CNPJ/CPF Cliente", "Cód. Vendedor", "Semana 1", "Semana 2", "Semana 3"],
    optionalColumns: ["Marca", "Semana 4", "Semana 5"],
    notes: [
      "Marque com \"x\" as semanas em que o PDV será visitado (layout de 3, 4 ou 5 semanas).",
      "Mais de uma marcação na mesma semana conta como 1 visita/semana; visitas em mais de uma semana são permitidas.",
      "O cliente é identificado pelo CNPJ/CPF (ou Cód. PDV); cada importação substitui o roteiro vigente.",
      "Baixe o modelo na tela Planner › Parametrização.",
    ],
  },
];
