...
### Custo de nuvem por distribuidor

Dividindo o total de nuvem pelo número de distribuidores, o **custo unitário cai conforme a base cresce** — os custos fixos (plano base, compute, alarmes) diluem em mais distribuidores. É a economia de escala típica de SaaS:

| Fase | Distribuidores | Total nuvem/mês | **Custo por distribuidor/mês** |
|---|---:|---:|---:|
| **Piloto** | 15 | ~R$ 240 | **~R$ 16** |
| **Fase 1** | 50 | ~R$ 495 | **~R$ 10** |
| **Break-even** | 150 | ~R$ 1.320 | **~R$ 9** |
| **Escala** | 2.500 | ~R$ 9.490 | **~R$ 4** |

Em outras palavras: no início cada distribuidor "custa" ~R$ 16/mês de nuvem; ao chegar no break-even isso já está em ~R$ 9 e, na escala, ~R$ 4. Como referência de margem, é o custo de infraestrutura que precisa caber dentro do preço cobrado por distribuidor. (Não inclui domínio, e-mail transacional, monitoramento pago ou mão de obra — só a nuvem de dados.)
